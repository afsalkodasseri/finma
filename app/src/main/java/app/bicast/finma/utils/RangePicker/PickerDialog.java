...
public class PickerDialog {
    ...
    int currentPickerDrw= R.drawable.widget_rangepicker_selected_type;
    int prevPickerDrw= R.drawable.widget_rangepicker_selected_type_grey;
    int CrTextColor=Color.WHITE;
    int PrTextColor=Color.BLACK;

    int TodayDrw= R.drawable.widget_rangepicker_date_square_color_out;
    int StartDrw= R.drawable.widget_rangepicker_custom_date_start;
    int EndDrw= R.drawable.widget_rangepicker_custom_date_end;
    int MidDrw= R.drawable.widget_rangepicker_custom_date_range_p;
    int SingleDrw= R.drawable.widget_rangepicker_date_square_color_blue;
